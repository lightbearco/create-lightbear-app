...
export async function getProjectConfiguration(): Promise<ProjectAnswers> {
	const answers = await inquirer.prompt([
		...
		},
		{
			...
			choices: [
				{ name: "👤 Clerk (complete auth solution)", value: "clerk" },
		...
		},
		{
			...
			choices: [
				...
				{
					name: "⚛️  React Testing Library (component testing)",
		...
		},
		{
			...
			choices: [
				...
				{
					name: "🎨 Storybook + Chromatic (visual testing)",
					value: "storybook-chromatic",
				},
				{
					name: "🔍 React DevTools (browser extension recommended)",
					value: "react-devtools",
				},
				{
					name: "📏 Storybook + Figma Design Tokens",
					value: "storybook-figma",
				},
				{
					name: "🎯 Complete UI Suite (Storybook + Chromatic + DevTools)",
					value: "complete-suite",
				},
				{ name: "🚫 None", value: "none" },
			],
			default: "none",
		...
		},
		{
			...
			choices: [
				...
				{ name: "📡 Ably (realtime messaging)", value: "ably" },
				{ name: "🚫 None", value: "none" },
			],
			default: "none",
		},
	...
	const projectAnswers: ProjectAnswers = {
		...
		databaseProvider: answers.databaseProvider || "neon",
		authentication: answers.authentication || "clerk",
